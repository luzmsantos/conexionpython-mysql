...
result = cursor.execute("SELECT gesto,headx, heady, headz, neckx, necky, neckz, hipleftx, hiplefty, hipleftz, footleftx, footlefty,"
                        ...
                        "spineshoulderz FROM frame WHERE gesto = 'brazo arriba'")

archivo = open('C:\Users\MCC1\conexionbdb\BrazoArribaconsulta.txt', 'a') #CONSULTA
archivito = open('C:\Users\MCC1\conexionbdb\Brazo_Arriba.txt', 'a')
...
for line in open('BrazoArribaconsulta.txt'):
